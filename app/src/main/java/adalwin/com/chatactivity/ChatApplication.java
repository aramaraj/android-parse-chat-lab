package adalwin.com.chatactivity;
...
import adalwin.com.chatactivity.model.Message;
...
public class ChatApplication extends Application{
    ...
    public void onCreate() {
        ...
        Parse.initialize(new Parse.Configuration.Builder(this)
                .applicationId("classconnect") // should correspond to APP_ID env variable
                .addNetworkInterceptor(new ParseLogInterceptor())
                .server("https://classconnect.herokuapp.com/parse/").build());
        /*Parse.initialize(new Parse.Configuration.Builder(this)
